...
export default function ModalProduct({
  ...
  return (
    <>
      <div className="bg-black w-full h-full opacity-50 absolute z-10" />
      <div className="fixed z-20 w-full md:w-1/2 h-1/2 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        <div className="bg-white p-2">
          <p className="text-right cursor-pointer" onClick={onClickClose}>
            X
          </p>
          ...
          <div className="flex flex-col items-center gap-4 my-4">
            <div className="flex gap-2 items-center">
              ...
              <input
                ...
                type="text"
                value={mode === "edit" ? form.name : undefined}
            ...
            <div className="flex gap-2 items-center">
              ...
              <input
                ...
                min={0}
                type="number"
                value={mode === "edit" ? form.price : undefined}
                onChange={(event) => onChangeForm("price", parseInt(event.target.value))}
              />
            </div>
            <div className="flex gap-5 items-center">
              ...
              <input
                ...
                min={0}
                type="number"
                value={mode === "edit" ? form.stock : undefined}
                onChange={(event) => onChangeForm("stock", parseInt(event.target.value))}
              />
            </div>
          </div>
